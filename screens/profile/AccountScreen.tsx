    ...
    <div className="p-6 md:p-10 space-y-8 animate-in fade-in duration-300 pb-32 text-white">
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex flex-col items-center gap-3 w-full md:w-auto">
          <div className="relative group cursor-pointer w-28 h-28 rounded-full overflow-hidden border-4 border-[#E8B84B] shadow-2xl bg-[#183D73]">
            <img 
              src={formData.avatar} 
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#183D73] border border-[#E8B84B]/40 rounded-full">
            <span className="text-[10px] font-bold uppercase tracking-wider text-[#E8B84B]">Niveau {user.level}</span>
          </div>
        </div>
        ...
        <div className="flex-1 w-full space-y-7">
          ...
          <section className="space-y-3">
            <h3 className="flex items-center gap-2 text-xs font-bold text-[#E8B84B] uppercase tracking-wider border-b border-white/10 pb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <div className="bg-[#183D73]/30 border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3 focus-within:border-[#E8B84B]">
              ...
              <div className="space-y-1">
                ...
                <div className="bg-[#183D73]/30 border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3 opacity-70">
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="md:col-span-3 bg-[#183D73]/30 border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3 focus-within:border-[#E8B84B]">
              ...
              <div className="bg-[#183D73]/30 border border-white/10 rounded-xl px-4 py-3">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              {paymentHistory.map(pay => (
                <div key={pay.id} className="bg-[#183D73]/30 border border-white/10 rounded-xl p-3.5 flex items-center justify-between">
          ...
          <button 
            onClick={handleSave}
            disabled={isSaving}
            className="w-full py-4 bg-[#E8B84B] hover:bg-[#FCE082] text-[#0F172A] rounded-xl font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-xl cursor-pointer"
          >
