      ...
      playerRef.current = new window.YT.Player('youtube-player', {
        ...
        events: {
          onReady: (event: any) => {
            ...
            const savedProgress = localStorage.getItem(`academylona_progress_${lesson.id}`) || localStorage.getItem(`cerclehub_progress_${lesson.id}`);
            if (savedProgress) {
            ...
            progressIntervalRef.current = window.setInterval(() => {
              if (playerRef.current && playerRef.current.getCurrentTime) {
                ...
                setCurrentTime(time);
                localStorage.setItem(`academylona_progress_${lesson.id}`, time.toString());
