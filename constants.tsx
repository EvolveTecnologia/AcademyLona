...
const EXCELLENTIA_COURSES: Course[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1508873696983-2df5293cb325?q=80&w=600&auto=format&fit=crop',
    heroImage: 'https://images.unsplash.com/photo-1508873696983-2df5293cb325?q=80&w=1200&auto=format&fit=crop',
    progress: 0,
    duration: '90h',
    modulesCount: 3,
    isExcellentia: true,
...
const AUTONOMISATION_COURSES: Course[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?q=80&w=600&auto=format&fit=crop',
    heroImage: 'https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?q=80&w=1200&auto=format&fit=crop',
    progress: 0,
    duration: '50h',
    modulesCount: 3,
    modules: [
