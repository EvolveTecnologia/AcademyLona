  ...
  return (
    <>
      ...
      <aside 
        ...
        className="fixed bottom-16 md:bottom-6 left-3 right-3 sm:left-auto sm:right-6 sm:max-w-md z-40 bg-gradient-to-r from-[#0F172A]/95 via-[#1E293B]/95 to-[#183D73]/95 backdrop-blur-xl border border-[#E8B84B]/40 rounded-2xl p-3 sm:p-3.5 shadow-2xl animate-in slide-in-from-bottom duration-300 text-white"
      >
        <div className="flex items-center justify-between gap-3">
          
          {/* App Icon + Info */}
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            <div className="w-10 h-10 rounded-xl bg-[#183D73] p-1.5 border border-[#E8B84B]/30 shadow-md shrink-0 flex items-center justify-center">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5">
                <h4 className="text-xs font-black uppercase tracking-wide text-white truncate">
                  Installer Academy Lona
                </h4>
                <span className="text-[9px] bg-[#E8B84B] text-[#0F172A] px-1.5 py-0.2 rounded-full font-bold uppercase shrink-0">
                  App
                </span>
              </div>
              <p className="text-[10px] text-gray-300 truncate">
                {isIOS ? 'Sur votre iPhone & iPad' : 'Fondation Lona • Hors-ligne'}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <button
              ...
              className="px-3.5 py-2 bg-[#183D73] hover:bg-[#224f91] active:scale-95 text-white rounded-xl text-xs font-black uppercase tracking-wider flex items-center gap-1.5 shadow-lg transition-all cursor-pointer border border-[#E8B84B]/50"
            >
              {isTriggering ? (
